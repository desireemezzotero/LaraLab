@php
    $projectMember = $task->project
        ->users()
        ->where('user_id', auth()->id())
        ->first();

    // Se l'utente non è nel progetto, il ruolo è null, altrimenti prendiamo quello della pivot
    $userRoleInProject = $projectMember ? $projectMember->pivot->project_role : null;
@endphp
