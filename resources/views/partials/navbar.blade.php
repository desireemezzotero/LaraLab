<nav class="bg-black border-gray-200 text-white">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
      <img src="#" class="h-8 rounded-full" alt="Flowbite Logo" />
    </a>
    ...
    <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      ...
      <div class="z-50 hidden my-4 text-base list-none bg-black divide-y divide-gray-100 rounded-lg shadow-sm" id="user-dropdown">
        <ul class="py-2" aria-labelledby="user-menu-button">
          <li>
            <a href="#" class="block px-4 py-2 text-sm text-white">Accedi</a>
          </li>
          <li>
            <a href="#" class="block px-4 py-2 text-sm text-white">Registrati</a>
          </li>
        </ul>
      </div>
